                ...
                if(Keyboard.getEventKeyState())
                {
                    ...
                    } else
                    {
                        ...
                        } else
                        {
							...
							//SnorriDev
							boolean saberOut = false;
							ItemStack s = thePlayer.inventory.getCurrentItem();
							try {
								Item thingy = s.getItem();
								saberOut = thingy instanceof net.minecraft.src.ItemLightsaber;
							}
