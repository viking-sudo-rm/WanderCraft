...
public class Block
{
	...
	//SnorriDev
	public static final Block machinery;
	public static final Block deathstarcore;
	//SnorriDev
    ...
    static 
    {
		...
		//SnorriDev
		machinery = (new BlockMachinery(123, 211)).setHardness(1.5F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("machinery");
		deathstarcore = (new BlockDeathStarCore(124,212)).setHardness(1.5F).setResistance(10F).setStepSound(soundStoneFootstep).setBlockName("deathstarcore");
		//SnorriDev
