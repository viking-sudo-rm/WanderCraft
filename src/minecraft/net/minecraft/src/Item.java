...
public class Item
{
	...
	//SnorriDev
	public static Item bluelightsaber = (new ItemLightsaber(2030)).setFull3D().setIconIndex(144).setItemName("blueLightsaber");
	public static Item redlightsaber = (new ItemLightsaber(2031)).setFull3D().setIconIndex(145).setItemName("redLightsaber");
	public static Item greenlightsaber = (new ItemLightsaber(2032)).setFull3D().setIconIndex(146).setItemName("greenLightsaber");
	public static Item purplelightsaber = (new ItemLightsaber(2033)).setFull3D().setIconIndex(147).setItemName("purpleLightsaber");
