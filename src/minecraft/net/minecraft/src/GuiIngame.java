        ...
        if(!mc.playerController.func_35643_e())
        {
            ...
            if(mc.playerController.shouldDrawHUD())
            {
				...
				try {
					...
					if (thingy instanceof ItemBlasterPistol) {
						if (((ItemBlasterPistol)thingy).getHeat()) {
							fontrenderer.drawString("Overheated!!!",(k - fontrenderer.getStringWidth("Overheated!!!")) / 2,l / 2,0xFF0000);
						}
					}
				}
