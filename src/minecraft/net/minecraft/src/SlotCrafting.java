...
public class SlotCrafting extends Slot
{
    ...
    public void onPickupFromSlot(ItemStack itemstack)
    {
		...
		//SnorriDev crafting achievements
		if (itemstack.itemID == Item.bluelightsaber.shiftedIndex || itemstack.itemID == Item.greenlightsaber.shiftedIndex || itemstack.itemID == Item.purplelightsaber.shiftedIndex) {
			thePlayer.addStat(AchievementList.mayTheForceBeWithYou, 1);
		}
